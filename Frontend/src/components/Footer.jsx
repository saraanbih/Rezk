...
const Footer = () => {
    return (
        <footer className = "footer_content py-[90px] px-[70px] bg-[url('https://i.ibb.co/gM1vhF9G/Rectangle-634.png')] w-[100%] bg-cover relative before:content-[''] before:absolute before:size-full before:top-0 before:bottom-0 before:left-0 before:right-0 before:bg-[#2D9CDBB8] ">
            <div style={{display:"grid",gridTemplateColumns:"repeat(auto-fit, minmax(400px, 1fr))", width:"100%"}} className = "content z-10 relative flex gap-[20px] items-start justify-between">
